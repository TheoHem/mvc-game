...
{
    $testVar = "This is a string from testFunc";
    return $testVar;
}
...
class TestClass {
    ...
    function testFunc(): string
    {
        $testVar = "This is a string from testFunc in the TestClass";
        return $testVar;
    }
}
...
class Dice {
    ...
    function set_lastThrow($lastThrow) {
    ...
    function rollDice() {
        $this->lastThrow = round(($this->sides * rand(10, 100)) / 100);
        return $this->lastThrow;
    }
}
...
class GraphicalDice extends Dice {
    ...
    function get_picture() {
        return "/img/dice" . strval($this->rollDice()) . ".jpg";
    }
}
